...
WebUI.setText(findTestObject('Object Repository/Registration/input_Nama Depan_firstName'), 'Hena')

WebUI.setText(findTestObject('Object Repository/Registration/input_Nama Belakang_lastName'), 'Triana')

WebUI.click(findTestObject('Registration/button_Daftar'))
